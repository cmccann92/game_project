    ...
    def shoot(self, enemy):
        for item in self.weapon:
            if 'melee' in item.type:
                ...
                print(f"You hit the {enemy}. You did {self.damage} damage.")
                return True 
...
class Medic(Character):
    ...
    def take_damage(self, damage):
        ...
        self.health += 3
        print(
            f"You took {total} damage. You healed yourself for 3 with your self heal ability. Remaining health: {self.health}")
